...
int main(int argc, char *argv[])
{
 //  int symbol = 1;				/* Shaded sphere symbol */
	...
	FILE *pt1_stab1 = fopen(argv[6], "r");
	struct Pts3d pt1_stab_prt1=ReadPts3dFile(pt1_stab1);
	FILE *pt1_unstab1 = fopen(argv[7], "r");

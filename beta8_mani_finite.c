...
//    s2pt(100,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(3);
//    s2pt(46000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(5);
//	s2pt(850,Pts.xs,Pts.ys,Pts.zs,4);
...
//	s2pt(700,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(8);
//	s2pt(400,Pts.xs,Pts.ys,Pts.zs,4);
...
//	s2pt(1170,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(6);
	s2pt(300000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(34);
    s2pt(90000,Pts.xs,Pts.ys,Pts.zs,1);

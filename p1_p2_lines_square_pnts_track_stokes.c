...
//   double nms=4752.0;   
   ...
   s2sci(6);
   pushVRMLname("p1pt504_backw_prds_1_300");
   struct Pts3d pts504b_2=ReadSelectedPts3d(pts504b, npart*1, npart*301);
   ...
   s2sci(1);
   pushVRMLname("p1pt506_forw_prds_1_300");
   struct Pts3d pts506f_2=ReadSelectedPts3d(pts506f, npart*1, npart*301);
   s2pt(pts506f_2.ns,pts506f_2.xs,pts506f_2.ys,pts506f_2.zs,1);
   s2sci(6);
   pushVRMLname("p1pt506_backw_prds_1_300");
   struct Pts3d pts506b_2=ReadSelectedPts3d(pts506b, npart*1, npart*301);
   ...
   s2sci(1);
   pushVRMLname("p1pt508_forw_prds_1_500");
   struct Pts3d pts508f_2=ReadSelectedPts3d(pts508f, npart*1, npart*501);
   s2pt(pts508f_2.ns,pts508f_2.xs,pts508f_2.ys,pts508f_2.zs,1);
   s2sci(6);
   pushVRMLname("p1pt508_backw_prds_1_300");
   struct Pts3d pts508b_2=ReadSelectedPts3d(pts508b, npart*1, npart*301);

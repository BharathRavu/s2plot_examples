...
//	s2pt(650,Pts.xs,Pts.ys,Pts.zs,4);
 ...
 //   s2pt(100,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(3);
 //   s2pt(30000,Pts.xs,Pts.ys,Pts.zs,1);
...
//	s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(8);
//	s2pt(490,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(1);
//	s2pt(580,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(6);
	s2pt(250000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(32);
	s2pt(150,Pts.xs,Pts.ys,Pts.zs,4);
    ...
    s2sch(0.2);
	s2sci(33);
	s2pt(11000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(34);
    s2pt(135000,Pts.xs,Pts.ys,Pts.zs,1);
...
/*	
    pushVRMLname("pt2_2d_mani_stable");  
    f1 = fopen(argv[19], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(8);

...
//   int symbol = 1;				/* Shaded sphere symbol */
   ...
   s2svp(-1,1, 0,1, -1,1);
	...
	s2sch(0.2);
    s2sci(7);
//	s2pt(1380,Pts.xs,Pts.ys,Pts.zs,4);
 ...
 //   s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(3);
//    s2pt(40000,Pts.xs,Pts.ys,Pts.zs,1);
//    s2pt(23000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(5);
//	s2pt(990,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(5);
//	s2pt(950,Pts.xs,Pts.ys,Pts.zs,4);
...
//	s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(8);
//	s2pt(1400,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(1);
	s2pt(1450,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(6);
	s2pt(240000,Pts.xs,Pts.ys,Pts.zs,1);
...
//	s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
	...
	pushVRMLname("pt4_2d_mani_stable");  
	f1 = fopen(argv[14], "r");
	Pts=ReadPts3dFile(f1);
    s2sch(0.2);
	s2sci(33);
//	s2pt(5000,Pts.xs,Pts.ys,Pts.zs,1);
...
//	s2pt(700,Pts.xs,Pts.ys,Pts.zs,4);
 ...
 //   s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(34);
 //   s2pt(75000,Pts.xs,Pts.ys,Pts.zs,1);

...
int main(int argc, char *argv[])
{
   int symbol = 1;				/* Shaded sphere symbol */
	...
	struct Pts3d Pts1_U=ReadPts3dFile(fin2u);
	...
	struct Pts3d Stable_M2=ReadPts3dFile(fin3);
	FILE *fin4 = fopen(argv[4], "r");
	struct Pts3d Unstable_M2=ReadPts3dFile(fin4);
...
//   s2sci(7);
   ...
   s2sch(0.6);
   s2pt(Stable_M1.ns,Stable_M1.xs,Stable_M1.ys,Stable_M1.zs,symbol);

s2sci(8);

s2pt(Unstable_M1.ns,Unstable_M1.xs,Unstable_M1.ys,Unstable_M1.zs,symbol);

s2sci(7);
s2pt(Stable_M2.ns,Stable_M2.xs,Stable_M2.ys,Stable_M2.zs,symbol);

s2sci(6);
s2pt(Unstable_M2.ns,Unstable_M2.xs,Unstable_M2.ys,Unstable_M2.zs,symbol);

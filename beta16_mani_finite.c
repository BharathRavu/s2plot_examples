...
//   int symbol = 1;				/* Shaded sphere symbol */
   ...
   s2svp(-1,1, 0,1, -1,1);
	...
	s2sch(0.2);
    s2sci(7);
//	s2pt(650,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(7);
//   s2pt(100,Pts.xs,Pts.ys,Pts.zs,4);
    
    pushVRMLname("pt4_2d_mani_unstable");  
    f1 = fopen(argv[4], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(3);
//   s2pt(24000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(5);
//	s2pt(700,Pts.xs,Pts.ys,Pts.zs,4);
...
//	s2pt(650,Pts.xs,Pts.ys,Pts.zs,4);
    ...
    pushVRMLname("pt5_1d_mani_unstable1");  
    f1 = fopen(argv[7], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(8);
//	s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
    ...
    pushVRMLname("pt5_1d_mani_unstable2");  
    f1 = fopen(argv[8], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(8);
...
//	s2pt(Pts.ns,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(1);
	s2pt(630,Pts.xs,Pts.ys,Pts.zs,4);
    
    pushVRMLname("pt6_2d_mani_unstable");  
    f1 = fopen(argv[11], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(6);
	s2pt(150000,Pts.xs,Pts.ys,Pts.zs,1);
		
    pushVRMLname("pt7_1d_mani_unstable1");  
    f1 = fopen(argv[12], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(32);
    ...
    pushVRMLname("pt7_1d_mani_unstable2");  
    f1 = fopen(argv[13], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(32);
	...
	s2sch(0.2);
    s2sci(33);
	s2pt(550,Pts.xs,Pts.ys,Pts.zs,4);
  
    pushVRMLname("pt8_1d_mani_stable1");  
    f1 = fopen(argv[16], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(35);
    ...
    pushVRMLname("pt8_1d_mani_stable2");  
    f1 = fopen(argv[17], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(35);
    ...
    pushVRMLname("pt8_2d_mani_unstable");  
    f1 = fopen(argv[18], "r");
    Pts=ReadPts3dFile(f1);
	s2sch(0.2);
    s2sci(34);
    s2pt(43000,Pts.xs,Pts.ys,Pts.zs,1); 

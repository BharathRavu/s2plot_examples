...
//   int symbol = 1;				/* Shaded sphere symbol */
   ...
   s2svp(-1,1, 0,1, -1,1);
	...
	s2sch(0.2);
    s2sci(3);
    s2pt(25000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(5);
	s2pt(1350,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(8);
	s2pt(450,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(1);
	s2pt(1500,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(6);
	s2pt(200000,Pts.xs,Pts.ys,Pts.zs,1);
    ...
    s2sch(0.2);
	s2sci(33);
	s2pt(6000,Pts.xs,Pts.ys,Pts.zs,1);
	...
	s2sch(0.2);
    s2sci(35);
	s2pt(900,Pts.xs,Pts.ys,Pts.zs,4);
	...
	s2sch(0.2);
    s2sci(34);
    s2pt(70000,Pts.xs,Pts.ys,Pts.zs,1);
